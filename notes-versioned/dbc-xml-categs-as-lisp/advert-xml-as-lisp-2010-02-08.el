;;; :FILE-CREATED <Timestamp: #{2010-02-08T12:37:12-05:00Z}#{10061} - by MON>
;;; :FILE c:/home/sp/HG-Repos/mon-notes-HG/dcp-xml-categs-as-lisp/advert-xml-as-lisp-2010-02-08.el
;;; ==============================
;;; (print (mapcar 'cadr '( ;;    { ... XML LISTS HERE ... }
;;;                        ))(current-buffer))
;;; ==============================
((category
  (categ
...
("Alpha Romeo" "American Motors" "Auburn" "Audi" "Austin-Healy" "BMW" "Ballot" "Berliet" "British Motor Corp" "Bugatti" "Buick" "Cadillac" "Chenard and Walcker" "Chevrolet" "Chrysler" "Citroen" "Cole Motor Cars" "Cottin and Desgouttes" "Datsun" "DeDion Bouton" "DeSoto" "Delage" "Delahaye" "Delaunay Belleville" "Dodge Brothers" "Fiat" "Ford" "General Motors" "George Irat" "Graham - Paige" "Hillman" "Holden" "Honda" "Hudson" "Humber" "Hupmobile" "International Trucks" "Jaguar" "Jeep" "Jordan" "Lancia" "Lincoln" "MG" "Manessius" "Marmon" "Maxwell Motors" "Mercedes-Benz" "Mercury" "Milburn" "Million - Guiet" "Morris" "Nash" "Nissan" "Oldsmobile" "Opel" "Packard" "Panhard" "Peerless" "Peugeot" "Pierce - Arrow" "Plymouth" "Pontiac" "Porsche" "Renault" "Rochet Schneider" "Rolland Pilain" "Rolls Royce" "Rootes Group" "Rover" "Saab" "Salmson" "Saturn" "Senechal" "Simca" "Sizaire" "Standard-Triumph" "Studebaker" "Sunbeam" "Toyota" "Unic" "Vauxhall" "Voisin" "Volkswagen" "Volvo" "White Motor Company" "Willys-Overland" "Wuling")
