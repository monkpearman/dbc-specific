...
;;; bknr-datastore-20101006-git/src/utils/date-calc.lisp
;;; ==============================

(in-package #:cl-user)

(defpackage #:dbc-date-cacl 
  (:use #:cl)
  (:export #:*language*
	   #:decode-day-of-week
...
;;; Parts taken from date-calc.el (EMACS, Doug Alcorn, <doug@lathi.net>, Ver. 0.1, 2003)
;;; and the
...
#| :WAS
 ...
 (defpackage #:date-calc
   (:use #:cl)
   (:export #:*language* #:decode-day-of-week #:cl-decode-day-of-week
	    #:decode-month #:decode-language #:iso-lc #:iso-uc #:year-to-days #:fixed-window
	    #:center #:valid-year-p #:valid-month-p #:leap-year #:leap-year-p
	    #:days-in-month #:days-in-year #:check-date #:check-business-p #:check-time-p
	    #:day-of-year #:date-to-days #:day-of-week #:weeks-in-year #:delta-days
	    #:week-number #:week-of-year #:add-delta-days #:monday-of-week
	    #:nth-weekday-of-month-year #:standard-to-business #:business-to-standard
	    #:delta-hms #:delta-dhms #:delta-ymd #:delta-ymdhms #:normalize-dhms
	    #:add-delta-dhms #:add-year-month #:add-delta-ym #:add-delta-ymd
	    #:add-delta-ymdhms #:system-clock #:cl-system-clock #:gmtime #:localtime #:today
	    #:yesterday #:tomorrow #:now #:today-and-now #:this-year #:date-to-text
	    #:date-to-text-long #:cl-day-of-week #:cl-weeks-in-year #:cl-check-business-p
	    #:cl-nth-weekday-of-month-year #:cl-standard-to-business
	    #:cl-business-to-standard))
...
(defparameter year-of-epoc 70
  "Year of reference (epoc)")

;; "year-of-epoc" "*year-of-epoc*"
;; "century-of-epoc"   "*century-of-epoc*"
;; "days-in-year-arr"  "*days-in-year-array*"
;; "days-in-month-arr" "*days-in-month-array*"
;; "cl-decode-day-of-week" "decode-day-of-week-cl"
(defparameter century-of-epoc 1900
  "Century of reference (epoc)")

(defparameter eopoc (+ year-of-epoc century-of-epoc)
  "reference year (epoc)")

(defparameter days-in-year-arr
  (make-array '(2 13) :initial-contents
	      '((0 31 59 90 120 151 181 212 243 273 304 334 365)
		(0 31 60 91 121 152 182 213 244 274 305 335 366))))

(defparameter days-in-month-arr
  (make-array '(2 13) :initial-contents
	      '((0 31 28 31 30 31 30 31 31 30 31 30 31)
		(0 31 29 31 30 31 30 31 31 30 31 30 31))))

(defparameter languages 11
  #.(format nil "Languages which date-calculations can be prested in.~%~%~
                 ~{~1T~2,'0d~2@T~A~%~^~}"
	    '(0  "Default" 1 "English"   2 "Francais"   3  "Deutsch"
	      4  "Espanol" 5 "Portugues" 6 "Nederlands" 7  "Italiano"
	      8  "Norsk"   9  "Svenska" 10  "Dansk" 11  "suomi")))

;;   0  Default, the second value describes order:
;;   1  English    11=DMY 10=MDY see #'date-to-text-long
...
(setf (gethash 2 mcl-decode-day-of-weekonth-to-text)
...
(defun days-in-year (year &optional month)
  ...
  (aref days-in-year-arr
	(leap-year year)
	(if (and month (>= month 0) (<= month 12))
	    month
	    12)))
